...
template <class _ForwardIter1, class _ForwardIter2, class _T>
inline void __iter_swap(_ForwardIter1 __a, _ForwardIter2 __b, _T*) {
  _T __tmp = *__a;
  *__a = *__b;
  *__b = __tmp;
}
...
template <class _T>
inline void swap(_T& __a, _T& __b) {
  _T __tmp = __a;
  __a = __b;
  __b = __tmp;
}
...
template <class _T>
struct __copy_dispatch<_T*, _T*, __true_type>
{
...
template <class _T>
struct __copy_dispatch<const _T*, _T*, __true_type>
{
  static _T* copy(const _T* __first, const _T* __last, _T* __result) {
    return __copy_trivial(__first, __last, __result);
  }
...
inline _OutputIter copy(_InputIter __first, _InputIter __last,
                        _OutputIter __result) {
  typedef typename iterator_traits<_InputIter>::value_type _T;
  typedef typename __type_traits<_T>::has_trivial_assignment_operator
          _Trivial;
...
struct __copy_backward_dispatch<_T*, _T*, __true_type>
{
  static _T* copy(const _T* __first, const _T* __last, _T* __result) {
    ...
    memmove(__result - _Num, __first, sizeof(_T) * _Num);
...
{
  static _T* copy(const _T* __first, const _T* __last, _T* __result) {
    return  __copy_backward_dispatch<_T*, _T*, __true_type>
      ::copy(__first, __last, __result);
  }
};
...
pair<_InputIter, _OutputIter> __copy_n(_InputIter __first, _Size __count,
                                       _OutputIter __result,
                                       input_iterator_tag) {
  for ( ; __count > 0; --__count, ++__first, ++__result)
    *__result = *__first;
...
void fill(_ForwardIter __first, _ForwardIter __last, const _T& __value) {
  for ( ; __first != __last; ++__first)
    *__first = __value;
}

template <class _OutputIter, class _Size, class _T>
_OutputIter fill_n(_OutputIter __first, _Size __n, const _T& __value) {
